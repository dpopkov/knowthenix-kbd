package io.dpopkov.knowthenixkbd.api.v2.mappers
...
private fun String?.toAggregateId() = this?.let { KnthAggregateId(it) } ?: KnthAggregateId.NONE
...
private fun TranslationDebug?.transportToStubCase(): KnthStubs = when (this?.stub) {
    ...
    TranslationRequestDebugStubs.BAD_AGGREGATE_ID -> KnthStubs.BAD_AGGREGATE_ID
...
private fun TranslationCreateObject.toInternal() = KnthTranslation(
    ...
    aggregateId = this.aggregateId.toAggregateId(),
