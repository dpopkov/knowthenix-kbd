...
class MapperTest {
    ...
    fun fromTransport() {
        ...
        assertEquals(KnthAggregateId("aggregate id"), context.translationRequest.aggregateId)
    }
    ...
    fun toTransport() {
        val context = KnthContext(
            ...
            translationResponse = KnthTranslation(
                ...
                aggregateId = KnthAggregateId("aggregate id"),
        ...
        assertEquals("aggregate id", req.translation?.aggregateId)
